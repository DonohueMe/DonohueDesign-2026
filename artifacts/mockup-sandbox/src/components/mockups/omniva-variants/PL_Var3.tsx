...
export function PL_Var3() {
  return (
    <div style={{ fontFamily: SF, margin: 0, padding: 0, overflowX: 'hidden' }}>
      ...
      {/* ── Editorial body ── */}
      <div style={{ background: '#f5f5f7', padding: '60px 20px 80px' }}>
        <div style={{ maxWidth: 1020, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 340px', gap: 40, marginBottom: 48, alignItems: 'start' }}>

            {/* Left — prose */}
            <div>
              <p style={{ fontSize: 17, color: '#1d1d1f', lineHeight: 1.7, margin: '0 0 18px' }}>
                Most website designers jump straight into building. I start with strategy.
              </p>
              <p style={{ fontSize: 16, color: '#3d3d3f', lineHeight: 1.7, margin: '0 0 18px' }}>
              ...
              <p style={{ fontSize: 16, color: '#3d3d3f', lineHeight: 1.7, margin: 0 }}>
              ...
              <p style={{ fontSize: 16, color: '#3d3d3f', lineHeight: 1.7, margin: '18px 0 0' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 340px', gap: 40, marginBottom: 48, alignItems: 'start' }}>
            ...
            {/* Left — prose */}
            <div>
              <h3 style={{ fontSize: 22, fontWeight: 700, letterSpacing: '-0.03em', color: '#1d1d1f', margin: '0 0 16px' }}>What I Do</h3>
              <p style={{ fontSize: 16, color: '#3d3d3f', lineHeight: 1.7, margin: '0 0 18px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 340px', gap: 40, marginBottom: 48, alignItems: 'start' }}>
            ...
            {/* Left — prose */}
            <div>
              <h3 style={{ fontSize: 22, fontWeight: 700, letterSpacing: '-0.03em', color: '#1d1d1f', margin: '0 0 16px' }}>Beyond the Website</h3>
              <p style={{ fontSize: 16, color: '#3d3d3f', lineHeight: 1.7, margin: '0 0 18px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 340px', gap: 40, alignItems: 'start' }}>
            ...
            {/* Left — prose */}
            <div>
              <h3 style={{ fontSize: 22, fontWeight: 700, letterSpacing: '-0.03em', color: '#1d1d1f', margin: '0 0 16px' }}>Serving Santa Rosa and Sonoma County</h3>
              <p style={{ fontSize: 16, color: '#3d3d3f', lineHeight: 1.7, margin: '0 0 18px' }}>
