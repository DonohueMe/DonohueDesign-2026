  ...
  return (
    <div style={{ fontFamily: SF, margin: 0, padding: `0 ${sidePad}px`, background: '#fff', minHeight: '100vh' }}>
      ...
      <footer style={{ background: '#000', padding: isMobile ? '40px 20px 40px' : '48px 40px 48px', margin: `0 -${sidePad}px`, color: '#fff' }}>
        <div style={{ maxWidth: 1280, margin: '0 auto' }}>
          <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'auto auto', gap: isMobile ? 24 : 75, paddingBottom: 28, textAlign: isMobile ? 'center' : 'left', justifyContent: isMobile ? 'stretch' : 'center' }}>
