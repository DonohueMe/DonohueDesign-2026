          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 48, minWidth: 0 }}>
            ...
            <div style={{ background: '#fff', borderRadius: 20, padding: isMobile ? '28px 24px' : '44px 56px', position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: tileStack ? 'column' : 'row', gap: tileStack ? 24 : 56, alignItems: tileStack ? 'stretch' : 'center', boxShadow: '0 12px 40px rgba(0,0,0,0.08), 0 2px 6px rgba(0,0,0,0.04)' }}>
              <div style={{ flex: tileStack ? '1 1 auto' : 3, minWidth: 0 }}>
                <TileHeader tint="#2997ff" icon={ICON_BROWSER} label={<>Website Designer<span style={{color:'#b7b7b9'}}> Santa Rosa</span></>} />
                ...
                <p style={{ fontSize: 18, color: '#1d1d1f', lineHeight: 1.55, margin: 0 }}>
              ...
              <div style={{ flex: tileStack ? '1 1 auto' : 2, minWidth: 0, borderLeft: tileStack ? 'none' : '1px solid #e5e5ea', borderTop: tileStack ? '1px solid #e5e5ea' : 'none', paddingLeft: tileStack ? 0 : 40, paddingTop: tileStack ? 8 : 0 }}>
            ...
            <div style={{ background: '#fff', borderRadius: 20, padding: isMobile ? '28px 24px' : '44px 56px', position: 'relative', overflow: 'hidden', display: 'flex', gap: tileStack ? 24 : 56, alignItems: tileStack ? 'stretch' : 'center', flexDirection: tileStack ? 'column' : 'row-reverse', boxShadow: '0 12px 40px rgba(0,0,0,0.08), 0 2px 6px rgba(0,0,0,0.04)' }}>
              <div style={{ flex: tileStack ? '1 1 auto' : 3, minWidth: 0 }}>
                <TileHeader tint="#2997ff" icon={ICON_ENVELOPE} label={<>Digital Marketing<span style={{color:'#b7b7b9'}}> Santa Rosa</span></>} />
                <h3 style={{ fontSize: 30, fontWeight: 700, letterSpacing: '-0.03em', lineHeight: '37px', color: '#1d1d1f', margin: '0 0 20px' }}>
              ...
              <div style={{ flex: tileStack ? '1 1 auto' : 2, minWidth: 0, borderRight: tileStack ? 'none' : '1px solid #e5e5ea', borderTop: tileStack ? '1px solid #e5e5ea' : 'none', paddingRight: tileStack ? 0 : 40, paddingTop: tileStack ? 8 : 0 }}>
            ...
            <div style={{ background: '#fff', borderRadius: 20, padding: isMobile ? '28px 24px' : '44px 56px', position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: tileStack ? 'column' : 'row', gap: tileStack ? 24 : 56, alignItems: tileStack ? 'stretch' : 'center', boxShadow: '0 12px 40px rgba(0,0,0,0.08), 0 2px 6px rgba(0,0,0,0.04)' }}>
              <div style={{ flex: tileStack ? '1 1 auto' : 3, minWidth: 0 }}>
                <TileHeader tint="#2997ff" icon={ICON_PALETTE} label={<>Graphic Designer<span style={{color:'#b7b7b9'}}> Santa Rosa</span></>} />
                <h3 style={{ fontSize: 30, fontWeight: 700, letterSpacing: '-0.03em', lineHeight: '37px', color: '#1d1d1f', margin: '0 0 20px' }}>
