...
function ServicesMegaMenu() {
  ...
  return (
    <div style={{ position: 'relative' }} onMouseEnter={show} onMouseLeave={hide}>
      ...
      <div onMouseEnter={show} onMouseLeave={hide} style={{ position: 'fixed', top: 79, left: '50%', transform: 'translateX(-50%)', zIndex: 200, visibility: open ? 'visible' : 'hidden', pointerEvents: open ? 'auto' : 'none' }}>
  ...
  return (
    <div style={{ fontFamily: SF, margin: 0, padding: `0 ${sidePad}px`, background: '#fff', minHeight: '100vh', overflowX: 'hidden' }}>
      ...
      <header style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 1000, background: '#fff', padding: `0 ${sidePad}px`, display: 'flex', alignItems: 'center', height: 84 }}>
        <a href="#" style={{ display: 'flex', alignItems: 'center', textDecoration: 'none', flexShrink: 0, marginRight: 50 }}>
