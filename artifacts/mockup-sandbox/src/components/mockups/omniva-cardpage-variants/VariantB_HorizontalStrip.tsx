...
function ServicesMegaMenu() {
  ...
  return (
    <div style={{ position: 'relative' }} onMouseEnter={show} onMouseLeave={hide}>
      ...
      <div onMouseEnter={show} onMouseLeave={hide} style={{ position: 'fixed', top: 69, left: '50%', transform: 'translateX(-50%)', zIndex: 200, visibility: open ? 'visible' : 'hidden', pointerEvents: open ? 'auto' : 'none' }}>
