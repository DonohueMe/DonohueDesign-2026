            ...
            {[
              {
                ...
                icon: (
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#000" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
              ...
              <div key={eyebrow} style={{
                ...
                <h3 style={{
                  ...
                  lineHeight: '36.5px', margin: '0 0 14px', color: '#000',
                }}>
                  {title.map((line, i) => (
                ...
                <p style={{ fontSize: 15.5, lineHeight: 1.5, color: 'rgba(255,255,255,0.95)', margin: 0 }}>
                  {body}
                </p>
              </div>
            ))}
