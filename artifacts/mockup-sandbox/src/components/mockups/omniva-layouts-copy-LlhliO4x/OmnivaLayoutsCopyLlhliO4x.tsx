          ...
          {sections.map(({ h1 }, si) => (
            <React.Fragment key={si}>
              <div style={{ marginBottom: 56 }}>
                <p style={{ fontSize: 'clamp(22px, 3vw, 30px)', fontWeight: 700, margin: '0 0 0', lineHeight: 1.32, ...(GRAD_WARM as any), display: 'block' }}>
                  Strategy-Driven Design That Works
                </p>
                <h2 style={{ fontSize: 'clamp(22px, 3vw, 30px)', fontWeight: 800, letterSpacing: '-0.03em', color: '#1d1d1f', margin: '0 0 40px', lineHeight: 1.32 }}>
                  {h1}
                </h2>
                {BIO.map((para, pi) => (
