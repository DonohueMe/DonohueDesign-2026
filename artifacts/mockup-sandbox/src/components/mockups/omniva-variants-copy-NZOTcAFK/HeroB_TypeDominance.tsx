...
export function HeroB_TypeDominance() {
  return (
    <div style={{ fontFamily: SF, margin: 0, padding: 0, overflowX: 'hidden' }}>
      <StickyNav />

      {/* Hero — almost no background, type IS the event */}
      <section style={{
        minHeight: 680,
        background: 'linear-gradient(180deg, #faf8fc 0%, #f5f5f7 100%)',
        display: 'flex',
        ...
        {/* Barely-there tint — just a whisper of the brand palette */}
        <div style={{ position: 'absolute', top: -80, right: -120, width: 600, height: 600, borderRadius: '50%', background: 'radial-gradient(circle, rgba(196,153,226,0.18) 0%, transparent 70%)', pointerEvents: 'none' }} />
        <div style={{ position: 'absolute', bottom: -60, left: -80, width: 400, height: 400, borderRadius: '50%', background: 'radial-gradient(circle, rgba(255,185,120,0.14) 0%, transparent 70%)', pointerEvents: 'none' }} />
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: 1440 }}>
          ...
          <h1 style={{
            ...
            Website<br />Designer<br />
            <span style={{ color: '#c898e2' }}>Santa Rosa.</span>
          </h1>

          {/* Bottom row — subtext + CTA inline */}
          <div style={{ display: 'flex', alignItems: 'center', gap: 32, borderTop: '1px solid #e5e5ea', paddingTop: 28 }}>
            <p style={{ fontSize: 17, color: '#3d3d3f', lineHeight: 1.5, maxWidth: 420, margin: 0 }}>
              Strategy-driven web design and digital marketing for Sonoma County businesses.
            </p>
            <button style={{ flexShrink: 0, background: '#1d1d1f', color: '#fff', border: 'none', borderRadius: 980, padding: '14px 28px', fontSize: 16, fontWeight: 600, fontFamily: SF, cursor: 'pointer' }}>
              Get started
            </button>
          </div>
        </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 340px', gap: 40, alignItems: 'start' }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
              {[
                ...
                { h: 'What I Do', paras: ["I offer website design, website development, and website redesign for local businesses \u2014 from tasting rooms along Highway 12 to shops in Railroad Square to service companies in Rincon Valley.", "I also handle e-commerce website design, SEO-optimized website design, UX/UI design, and website maintenance."] },
                { h: 'Beyond the Website', paras: ["Your site is the foundation. I also offer local SEO services, email marketing automation, and AI-powered tools \u2014 AI chat assistants, AI receptionists, and AI voice assistants.", "On the brand side: logo design, brand identity, stationery, brochure and flyer design, infographic design, and presentation design."] },
